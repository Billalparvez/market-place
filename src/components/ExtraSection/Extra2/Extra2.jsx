            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div className="card  bg-base-100 shadow-xl ">
                        ...
                        <div>
                            <a >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 absolute top-10 right-5 text-white bg-[#63B916] hover:dropdown-content rounded-full p-1" fill="none"
                                    ...
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 
                                0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
                            </a>
                        </div>
                    </div>
                    <div className="card-body">
                        ...
                        <h2 className="card-title hover:text-[#63B916]">
                            ...
                            <div className="badge bg-[#63B916] text-white">Jobs</div>
                        </h2>
                ...
                <div className="card  bg-base-100 shadow-xl ">
                    ...
                    <div className="card-body">
                        ...
                        <h2 className="card-title hover:text-[#63B916]">
                            Long-lasting Technology careers for the future
                            <div className="badge bg-[#63B916] text-white">Tips</div>
                        </h2>
                ...
                <div className="card  bg-base-100 shadow-xl ">
                    ...
                    <div className="card-body">
                        <div>
                            <img className="absolute bottom-[183px] md:bottom-[163px] lg:bottom-[135px]  w-14 h-14 rounded-full border-4 border-white " src="https://i.postimg.cc/5N4WjTMz/cardano-blockchain-platform.jpg" alt="" />
                        </div>
                        <p className="font-bold text-gray-400 md:text-lg border-l-4 border-[#63B916] "><span className="ml-3">Kamran Adi - {moment().format('Do MMMM YYYY  ')}</span></p>
                        <h2 className="card-title hover:text-[#63B916]">
                            Long-lasting Technology careers for the future
                            <div className="badge bg-[#63B916] text-white">Technology</div>
                        </h2>
