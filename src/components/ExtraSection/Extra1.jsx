                    ...
                    <div className="flex mb-10 gap-3">
                        <div className="card bg-base-100 shadow-xl">
                            <figure className="px-10 pt-10">
                                <img src="https://i.postimg.cc/CLzGj6nx/3.jpg" alt="Shoes" className="rounded-xl" />
                            </figure>
                            <div className="card-body items-center text-center">
                                <h2 className="card-title">some one word health!</h2>
                                <p className="font-bold text-gray-400">this is description ONe the moment</p>
                                <div className="grid grid-flow-col gap-4">
                                    ...
                                    <Link to={'/about'}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        className="fill-current text-red-600 bg-purple-500 rounded-full "><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></Link>
                                </div>
                            </div>
                        </div>
                        <div className="card bg-base-100 shadow-xl">
