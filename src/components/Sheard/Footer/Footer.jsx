    ...
    return (
        <div className="bg-base-200 mt-20">
            <footer className="footer p-10 max-w-7xl mx-auto  text-base-content">
                <nav data-aos="fade-down">
                    <p data-aos="fade-left"
                        className=" text-lg md:text-3xl font-bold inline-block">
                        <span className="text-[#63B916]">Market</span> places
                    </p>
                    <p>Collin Street West, Victor 6007, Australia.</p>
                    <p>+1 246-345-0695</p>
                    <p>info@Zobstar123.com</p>
                    <h1 className="font-bold">Connect with us</h1>
                    <div className="flex gap-5 mt-3">
                        <Link to={'https://techydevs.com/demos/themes/html/zobstar-demo/zobstar/job-details.html'}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></Link>
                        <Link to={'https://techydevs.com/demos/themes/html/zobstar-demo/zobstar/job-details.html'}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></Link>
                        <Link to={'https://themeforest.net/item/qdesk-a-unique-job-board-psd-template/screenshots/23282880?index=1'}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"></path></svg></Link>
                    </div>
                </nav>
            ...
            <footer className="footer  max-w-7xl mx-auto px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside data-aos="" className="items-center grid-flow-col">
                ...
                <nav className="md:place-self-center md:justify-self-end">
                    <div data-aos="" className="grid grid-flow-col gap-4">
